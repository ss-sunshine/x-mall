<template>
  <div>
    ...
    <div class="content">
      <div class="f-a f-w" v-if="flag===false">
      ...
      <div v-if="flag===true">
        <div class="p-t-100 f-c-a">
          <img src="../../assets/error.png" alt class="error"/>
          <div class="f30">抱歉！出错了...</div>
        </div>
        <two class="p-t-160"></two>
      </div>
      <div class="Page f-a">
        <div class="f12 m-r-1">
          <span>共</span>
      ...
      if (this.priceGt === "" || this.priceLte === "") {
        this.$api
          ...
          .then(res => {
            ...
            //   this.arr1 = JSON.parse(localStorage.getItem("search"));
            //   this.arr.map(item => {
            //     this.arr1.map(item1 => {
            ...
            //   // let list = intersection(this.arr, arr1);
            // }
          })
          .catch(err => {
            console.log(err);
