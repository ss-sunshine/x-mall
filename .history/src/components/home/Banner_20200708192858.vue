<template>
  <div class="m-b-3 banner">
    <Carousel autoplay v-model="value" loop arrow="never" :radius-dot="true"  class="banner">
      <div v-for="item in banner.panelContents" :key="item.id" class="banner">
        <CarouselItem  class="banner">
          <div class="image" @click="detail(item)">
            ...
            <!-- <div class="dots p-r f-j">
              <div class="radius-dot" :class="{'radius-dots':id===item.id}"></div>
              <div class="radius-dot" :class="{'radius-dots':id===item.id}"></div>
              <div class="radius-dot" :class="{'radius-dots':id===item.id}"></div>
            </div> -->
          </div>
