      ...
      <div class="d-f">
        <div>
          <div v-for="(item,index) in detail.productImageSmall" :key="index">
            <div
              class="detail_img m-b-1"
              @click="clickImg(item,index)"
              :class="{'detail_img_hover':sum===index}"
            >
        ...
        <div v-for="(item,index) in detail.productImageSmall" :key="index">
          <div class="detail_banner m-lr-2" v-if="sum===index">
        ...
        <div>
          ...
          <div class="border_bottom_bottom f-a">
            ...
            <div class="f-a">
              <div class="less f-a-j" @click="clickLess">
                <div class="line"></div>
              </div>
...
export default {
  ...
  mounted() {
    ...
    let afterEqual = afterUrl.substring(afterUrl.indexOf('=')+1)
