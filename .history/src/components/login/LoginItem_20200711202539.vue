<template>
  <div>
    <div class="registered">
      <div class="f-c-a f20">
        <img src="../../assets/login.png" alt="" class="login m-t-5">
        <div class="m-t-3">使用 XMall 账号登陆官网</div>
      </div>
      <div class="bored_bottom">
        <Form ref="user" :model="user" :rules="ruleInline">
          <FormItem prop="username">
            <Input type="text" v-model="user.username" placeholder="账号" class="login_ipt" />
          </FormItem>
          <FormItem prop="password">
            <Input type="password" v-model="user.password" placeholder="密码" class="login_ipt" />
          </FormItem>
          ...
          <Checkbox v-model="single" class="f14 m-t-15 check f-aj-bw">
            <span>记住密码</span>
            <div class="f-a">
              <span class="ps">注册 XMall 账号</span>
              <div class="line"></div>
              <span class="ps">忘记密码？</span>
            </div>
          </Checkbox>
