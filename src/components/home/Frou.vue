<template>
  <div class="m-b-3">
    <topTitle>
      <template v-slot:title>品牌周边</template>
    </topTitle>
    <div class="box">
      <div class="d-f top">
        <div v-for="(item,index) in brandOne.slice(0,3)" :key="index" class="f-1">
      ...
      <div class="d-f">
        <div v-for="(item,index) in brandOne.slice(3)" :key="index" class="f-1">
          <div
            class="banner1 f-1 f-c-a-j"
